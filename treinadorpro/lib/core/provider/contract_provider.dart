...
final findAllActiveContractsViewModelProvider = StateNotifierProvider<FindAllActiveContractsViewModel,
    AsyncValue<ApiGenericResponse<List<ContractResponseModel>>>>((ref){
      final repository = ref.read(contractRepositoryProvider);
      return new FindAllActiveContractsViewModel(repository);
});