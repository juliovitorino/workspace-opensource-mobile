...
import '../viewmodel/add_training_pack_view_model.dart';

final trainingPackRemoteDataSourceProvider = Provider<ITrainingPackRemoteDatasource>((ref) {
...
final trainingPackPageResultViewModelProvider =
    StateNotifierProvider<
      TrainingPackPageResultViewModel,
      AsyncValue<PageResultResponseModel<TrainingPackModel>>
    >((ref) {
...
final trainingPackStudentsFromTrainerViewListModelProvider =
    StateNotifierProvider<
      TrainingPackStudentsFromTrainerViewListModel,
      AsyncValue<List<StudentsFromTrainerResponseModel>>
    >((ref) {
      final repository = ref.read(trainingPackRepositoryProvider);
...
final trainingPackFromTrainerViewListModelProvider =
    StateNotifierProvider<
      TrainingPackFromTrainerViewListModel,
      AsyncValue<List<TrainingPackModel>>
    >((ref) {
      final repository = ref.read(trainingPackRepositoryProvider);
      return TrainingPackFromTrainerViewListModel(repository);
    });

final addTrainingPackViewModelProvider =
    StateNotifierProvider<AddTrainingPackViewModel, AsyncValue<ApiGenericResponse<bool>>>((ref) {
      final repository = ref.read(trainingPackRepositoryProvider);
      return AddTrainingPackViewModel(repository);
    });
