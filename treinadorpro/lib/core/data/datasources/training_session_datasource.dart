...
class TrainingSessionDatasource implements ITrainingSessionDatasource {
  ...
  Future<ApiGenericResponse<bool>> save(UserTrainingSessionModel request) async {
    ...
    return ApiGenericResponse(Response(response['msgcode'], response['mensagem']), objectResponse);
  }
  ...
  Future<ApiGenericResponse<UserTrainingSessionModel>> findMostRecentTrainingSession(
    ...
    final String url =
        "${config.apiBackendUrl}/v1/api/business/training/session/$contractExternalId";
  ...
  Future<ApiGenericResponse<List<UserTrainingSessionModel>>> findTrainingSessionCalendar(
    ...
    final String url = "${config.apiBackendUrl}/v1/api/business/training/session/calendar";
    ...
    return ApiGenericResponse(
      Response(response['msgcode'], response['mensagem']),
      objectResponse.map((e) => UserTrainingSessionModel.fromJson(e)).toList(),
    );
  }
  ...
  Future<ApiGenericResponse<bool>> deleteTrainingSession(
    ...
    final String url =
        "${config.apiBackendUrl}/v1/api/business/training/session/${contractExternalId}/${trainingSessionExternalId}";
    ...
    final jsonResponse = await apiClient.delete(url, headers: headers);
    if (config.isDebugMode) {
      print("$module :: jsonResponse = $jsonResponse");
    }
