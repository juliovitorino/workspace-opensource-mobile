...
class _NewStudentPageState extends ConsumerState<NewStudentPage> {
  ...
  void _saveContract(BuildContext context) {
    if (_formKey.currentState!.validate()) {
      ...
      final String? _customTimeMon = _mondayController.trainingTime == '- x -'
          ? null
          : _mondayController.trainingTime;
      final String? _customTimeTue = _tuesdayController.trainingTime == '- x -'
          ? null
          : _tuesdayController.trainingTime;
      final String? _customTimeWed =
          _wednesdayController.trainingTime == '- x -'
          ? null
          : _wednesdayController.trainingTime;
      final String? _customTimeThu = _thursdayController.trainingTime == '- x -'
          ? null
          : _thursdayController.trainingTime;
      final String? _customTimeFri = _fridayController.trainingTime == '- x -'
          ? null
          : _fridayController.trainingTime;
      final String? _customTimeSat = _saturdayController.trainingTime == '- x -'
          ? null
          : _saturdayController.trainingTime;
      final String? _customTimeSun = _sundayController.trainingTime == '- x -'
          ? null
        ...
        child: Column(
          ...
          children: [
            ...
            ProWidgetTextFormField(
              ...
              label: 'Data de Encerramento (AAAA-MM-DD)',
              keyboardType: TextInputType.datetime,
            ),
