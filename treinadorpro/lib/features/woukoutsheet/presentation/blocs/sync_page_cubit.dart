...
class SyncPageCubit extends Cubit<HandlerState>{
  final ITrainingSessionRepository _repository;
  SyncPageCubit(this._repository) : super(HandlerState());

  Future<void> sync(UserTrainingSessionModel request) async {
